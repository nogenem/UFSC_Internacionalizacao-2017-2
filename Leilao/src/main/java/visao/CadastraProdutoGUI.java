...
public class CadastraProdutoGUI extends ParentGUI {
	...
	protected void constroiFrame(final PrincipalGUI parent, final MercadoLeilao mercado) {
		currentFrame.setTitle("Cadastrar Produto");
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					parent.mostraMensagemDeAlerta(currentFrame, "O valor do lance mínimo deve ser um numero.");
					System.err.println(e.getMessage());
				} catch (ParseException e) {
					parent.mostraMensagemDeAlerta(currentFrame, "Data limite invalida.");
					System.err.println(e.getMessage());
